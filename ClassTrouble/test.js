...
for (let i = 0; i < rounds.length; i++) {
  ...
  const availableQuestions = temp.filter(
    (question) => !usedQuestions.has(question.id_question)
  );
  for (let j = 0; j < nb; j++) {
...
async function StartTest() {
  ...
  camera.setAttribute(
    "movement-controls",
    "constrainToNavMesh: true; controls: checkpoint;"
  );
  ...
  infoBox.setAttribute(
    "material",
    "color:rgba(163, 163, 163, 0.75); opacity: 1"
  );
  ...
  progressText.setAttribute(
    "value",
    `Round ${round + 1}: ${
      data[round].length - questionIndex
    } questions remaining`
  );
...
//     // Create text elements for the responses
//     const textReponse1 = document.createElement("a-text");
//     textReponse1.setAttribute(
//       "value",
//       currentQuestion.reponses[0].texte_reponse
//     );
//     textReponse1.setAttribute("id", "reponse1");
//     textReponse1.setAttribute("color", "#000");
//     textReponse1.setAttribute("align", "center");
...
//     const textReponse2 = document.createElement("a-text");
//     textReponse2.setAttribute(
//       "value",
//       currentQuestion.reponses[1].texte_reponse
//     );
//     textReponse2.setAttribute("id", "reponse2");
//     textReponse2.setAttribute("color", "#000");
//     textReponse2.setAttribute("align", "center");
...
function nextQuestion(newIndex) {
  ...
  if (questionIndex >= data[round].length) {
    ...
    if (round < data.length - 1) {
      ...
      // End of the entire test
      questionElem.setAttribute(
        "value",
        "End of the test, you got " +
          cpt_resp +
          "/" +
          data.flat().length +
          " And you got " +
      ...
      setTimeout(() => {
        ...
        camera.setAttribute(
          "movement-controls",
          "constrainToNavMesh: true; controls: checkpoint, gamepad, trackpad, keyboard, nipple;"
        );
        const chair = document.querySelector("#cr-chair");
        chair.setAttribute("dynamic-body", "");
        const infoBox = document.querySelector("#infoBox");
...
let characterAnimation = function () {
  ...
  acharacter.setAttribute(
    "animation-mixer",
    "clip: CharacterArmature|Walk; loop: repeat; timeScale: 1"
  );
  acharacter.setAttribute("rotation", "0 90 0");
  acharacter.setAttribute(
    "animation",
    "property: position; to: 0 0 -8; dur: 1000; easing: linear"
  );

  setTimeout(function () {
    acharacter.setAttribute(
      "animation-mixer",
      "clip: CharacterArmature|Run; loop: repeat; timeScale: 1"
    );
    acharacter.setAttribute("rotation", "0 0 0");
    acharacter.setAttribute(
      "animation",
      "property: position; to: 0 0 2; dur: 2000; easing: linear"
    );
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        acharacter.setAttribute(
          "animation-mixer",
          "clip: CharacterArmature|Run_Back; loop: repeat; timeScale: 1"
        );
        acharacter.setAttribute(
          "animation",
          "property: position; to: 0 0 -4; dur: 2000; easing: linear"
        );
        acharacter.setAttribute("rotation", "0 0 0");
        ...
        setTimeout(function () {
          ...
          acharacter.setAttribute(
            "animation-mixer",
            `clip: CharacterArmature|${randomEmote}; loop: once; timeScale: 1`
          );
          acharacter.setAttribute(
            "animation",
            "property: position; to: 0 0 -8; dur: 2000; easing: linear"
          );
          ...
          setTimeout(function () {
            ...
            acharacter.setAttribute(
              "animation",
              "property: position; to: -2 0 -8; dur: 1000; easing: linear"
            );
            acharacter.setAttribute("rotation", "0 -90 0");
            ...
            setTimeout(function () {
              acharacter.setAttribute(
                "animation-mixer",
                "clip: CharacterArmature|Idle; loop: repeat; timeScale: 1"
              );
              acharacter.setAttribute("rotation", "0 0 0");
            }, 1000);
          }, 2000);
...
function shootBall() {
  ...
  ball.setAttribute(
    "animation",
    "property: position; to: 2 2 2.7; dur: 500; easing: linear"
  );
  character.setAttribute(
    "animation-mixer",
    "clip: CharacterArmature|Gun_Shoot; loop: once; timeScale: 1"
  );
